		...
		let addParameter = (event, parameterData) => {
		...
		let addNode = (parentElement, node, top = false) => {
		...
		let setAttributesVisibility = (nodeElement) => {
		...
		let setAddButtonsVisibility = (clickedNode) => {
		...
		let showAlert = (divAlertId, divAlertMessageId, message) => {
		...
		let removeClassOnElements = (styleClass) => {
