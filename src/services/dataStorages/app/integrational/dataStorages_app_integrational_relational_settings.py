...
class DataStoragesAppIntegrationalRelationalSettings(DataStoragesAppBaseSettings):
    #: имя сервиса
    svc_name: str = "dataStorages_app_integrational_relational"

    # код типа хранилища (prsDataStorage.prsEntityTypeCode)
    # 2 - integrational relational
