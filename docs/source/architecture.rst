...
теги коды качества: 100 при любом разрыве MQTT-сессии на брокере
(``connection.closed`` и LWT), 101 при первом запросе конфигурации новой сессии
до ответа ``full_configuration``. Подробнее см.
:doc:`Коннекторы <connectors>` (раздел «Связь по MQTT и коды качества тегов»).
