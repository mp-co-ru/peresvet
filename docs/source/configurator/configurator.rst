...
сведения о теге и запросе, все полученные точки и полный исходный JSON-ответ.
При изменении тега или параметров запроса экспорт блокируется до следующего
успешного запроса, чтобы в файл не попали устаревшие данные.
