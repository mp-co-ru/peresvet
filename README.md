...
В текущей версии платформы запуск сервисов, её составляющих, производится в
контейнерах. Возможны разные комбинации сервисов в одном контейнере.
Наиболее часто используемая конфигурация - когда в одном контейнере запускаются
все сервисы, относящиеся к одной сущности. К примеру, все сервисы группы
"alerts".
